...
Friend Class Form1
    ...
    Private A, B As dx_lib32.GFX_Rect ' Variables que contendran los valores de las dos cajas.
    ...
    Private Sub Form1_MouseMove(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles MyBase.MouseMove
        ...
        ' Obtenemos el resultado de la colision entre las dos cajas:
        Result = Sys.MATH_IntersectRect(A, B).ToString()
    ...
    Private Sub Form1_Paint(ByVal sender As System.Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles MyBase.Paint
        ...
        Gfx.DrawRectangle(Pens.GreenYellow, New Rectangle(B.X, B.Y, B.Width, B.Height))
