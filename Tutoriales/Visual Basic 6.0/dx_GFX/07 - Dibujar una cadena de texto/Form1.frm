...
Begin VB.Form Form1 
   ...
   Caption         =   "dx_GFX - Dibujar una cadena de texto"
   ClientHeight    =   3060
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   4560
...
Private TextFont As Long ' Identificador de la fuente.
...
Private Sub Form_Load()
    ...
    Do While Render
        Graphics.DRAW_Text TextFont, "Hola mundo!", 0, 0, 0, &HFFFFFFFF, Align_Left
